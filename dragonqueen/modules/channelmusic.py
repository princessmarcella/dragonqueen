...
from dragonqueen.modules.play import generate_cover
from dragonqueen.modules.play import arq
from dragonqueen.modules.play import cb_admin_check
from dragonqueen.modules.play import transcode
from dragonqueen.modules.play import convert_seconds
from dragonqueen.modules.play import time_to_seconds
from dragonqueen.modules.play import changeImageSize
from dragonqueen.config import BOT_NAME as bn
from dragonqueen.config import DURATION_LIMIT
from dragonqueen.config import UPDATES_CHANNEL as updateschannel
from dragonqueen.config import que
from dragonqueen.function.admins import admins as a
from dragonqueen.helpers.errors import DurationLimitError
from dragonqueen.helpers.decorators import errors
from dragonqueen.helpers.admins import get_administrators
from dragonqueen.helpers.channelmusic import get_chat_id
from dragonqueen.helpers.decorators import authorized_users_only
from dragonqueen.helpers.filters import command, other_filters
from dragonqueen.helpers.gets import get_file_name
from dragonqueen.services.callsmusic import callsmusic, queues
from dragonqueen.services.callsmusic.callsmusic import client as USER
from dragonqueen.services.converter.converter import convert
from dragonqueen.services.downloaders import youtube
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @dragonqueen_bot to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
